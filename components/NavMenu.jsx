...
export default function NavMenu() {
    ...
    return (
        <header className="bg-fondo py-5 px-10 flex justify-between items-center h-[15vh]">
            ...
            <div onClick={() => setEstaAbierto(!estaAbierto)} className="w-8 flex flex-col gap-2 lg:hidden group">
                <div className="rounded w-full h-1 bg-white group-hover:bg-azul group-active:bg-rosa rotate-45"></div>
                <div className="rounded w-full h-1 bg-white hidden"></div>
                <div className="rounded w-full h-1 bg-white group-hover:bg-azul group-active:bg-rosa -rotate-45"></div>
            </div>
